...
<head>
    <meta charset="utf-8">
    <title>Laporan Stok Niaga Jaya Electronic</title>
    <style>
        body { 
...
<body>
    ...
    <div class="judul-dokumen">Laporan Ketersediaan Stok Barang</div>
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th width="120" class="text-center">Keterangan Kondisi</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="fw-bold">{{ $p->kode_produk }}</td>
                <td>{{ $p->nama_produk }}</td>
                <td class="text-center">{{ $p->stok }} Unit</td>
                
                {{-- Keterangan Versi Teks Standar Tanpa Warna --}}
